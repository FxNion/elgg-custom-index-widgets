<?php
	...
	$english = array(
			...
			'custom_index_widgets:bookmarks' => "Latest bookmarks",
			'custom_index_widgets:groups' => "Latest groups",
			'custom_index_widgets:files' => "Latest files",
			'custom_index_widgets:blogs' => "Latest blog posts",
			'custom_index_widgets:members' => "Newest members",
			'custom_index_widgets:nofiles' => "There are no files yet",
			'custom_index_widgets:nogroups' => "There are no files yet",	
	
	

			'custom_index_widgets:news' => "Latest news",
			'custom_index_widgets:pages' => "Latest pages",
