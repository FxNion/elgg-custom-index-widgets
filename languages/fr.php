<?php
	...
	$french = array(
			...
			'custom_index_widgets:bookmarks' => "Derniers bookmarks",
			'custom_index_widgets:groups' => "Groupes les + r&eacute;cents",
			'custom_index_widgets:files' => "Fichiers les + r&eacute;cents",
			'custom_index_widgets:blogs' => "Derniers ajouts de blogs",
			'custom_index_widgets:members' => "Nouveaux membres",
